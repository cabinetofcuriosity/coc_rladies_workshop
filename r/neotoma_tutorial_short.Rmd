...
## Mapping all the mammal on map (interactive)
```{r}
...
leaflet() %>%
  ...
  addLayersControl(baseGroups = c("Black", "Standard"), position = "topleft",
                   options = layersControlOptions(collapsed = TRUE)) %>%
  addMarkers(data = mdata, 
             lat= ~lat, 
             lng = ~long, 
             layerId = ~taxon.name,
             clusterOptions = markerClusterOptions(),
             label = mdata$taxon.name,
             popup=paste(
               "<strong>ID: </strong>", mdata$X,
               "<br><strong>Taxon Name: </strong>", mdata$taxon.name,
               "<br><strong>Var units: </strong>", mdata$variable.units,
               "<br><strong>Var element: </strong>", mdata$variable.element,
               "<br><strong>Var context: </strong>", mdata$variable.context,
               "<br><strong>Taxon group: </strong>", mdata$taxon.group,
               "<br><strong>Site name: </strong>", mdata$site.name,
               "<br><strong>Age older: </strong>", mdata$age.older,
               "<br><strong>Age younger: </strong>", mdata$age.younger)
  )
